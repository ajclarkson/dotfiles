 ...
 * | Ctrl |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  '   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Shift |      | Alt  | GUI  |Lower |Space |Enter |Raise | Bksp | RGUI |      |RShif |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_LSFT, _______, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_BSPC, KC_RGUI, _______, KC_RSFT
),
 ...
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  | Left | Down |  Up  |Right |VOLUP |  |   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 | MPRV | MNXT | MPLY | MUTE |VOLDW |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT,   KC_DOWN,    KC_UP,    KC_RIGHT, KC_VOLU, KC_PIPE,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_MPRV,  KC_MNXT, KC_MPLY, KC_MUTE, KC_VOLD,  _______,
...
[_RAISE] = LAYOUT_ortho_4x12(
    ...
    _______,  KC_TILD,   KC_EQL,   KC_PLUS,   KC_MINS,   KC_SLSH,   KC_BSLS,   KC_UNDS, KC_QUOT,  KC_DQUO, KC_GRV, _______,
    _______, KC_PIPE,   KC_LBRC,   KC_LPRN,   KC_LCBR,  KC_LABK,  KC_RABK,  KC_RCBR, KC_RPRN, KC_RBRC, KC_PGDN, _______,
